...
public class WeaponManager
{
    ...
    public static void sort()
    {
        ...
        // BOMBERSDREAM
        bombersDream.Name = "Bomber's Dream";
        bombersDream.ATK = 45;
...
public class WeaponStats
{
    ...
    public static Weapon select()
    {
        ...
        {
            case 1:
                selectedWeapon.Name = WeaponManager.sharkM.Name;
            ...
            case 2 :
                selectedWeapon.Name = WeaponManager.mageShooter.Name;
            ...
            case 3:
                selectedWeapon.Name = WeaponManager.bombersDream.Name;
